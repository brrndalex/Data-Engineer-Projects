...
[8."Основы работы в консоли Linux, настройка сетевых служб (кластер)."]  
[9."Основы программирования для Linux."]  
[10."Введение в Linux."]   
[11."Docker для начинающих + практический опыт."]  
[12."Терминал Linux. Основы."]  
[13."DevOps простым языком"]   
[14.CI/CD простым языком; Командная строка для разработчиков – cli-for-dev;Git для начинающих: полный курс по основам и практике GitHub;Git для практикующих разработчиков: от новичка до профессионала;Основы Linux;GoStack: Основы Git и консольных команд;Linux - администрирование - Bash: кладовая полезных знаний;]                 
