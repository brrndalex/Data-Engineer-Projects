...
[14.CI/CD простым языком; Командная строка для разработчиков – cli-for-dev;Git для начинающих: полный курс по основам и практике GitHub;Git для практикующих разработчиков: от новичка до профессионала]              
